...
describe("Cease: Control Plus Vide", () => {
  test(
    "[Step1] Create new RCA via SSP",
    () => {
      let customerEmail =
        "HS_01_" +
        +btapi.getRandomInt(1, 99999) +
        "Jest" +
        btapi.getRandomInt(1, 99999) +
        "@email.com";
  ...
  test(
    "[Step 2] Create assigned SC with SHS+Commitment via CSR for RCA",
    () => {
      logger.info("CUSTOMER_ID:" + customerId);

      var offerList = [controlPlusVideoOffer, commitmentOffer];

      let body = btapi.generateShoppingCartBody.addTopOffers(
        customerAccountECID,
        customerCategory,
        distributionChannel,
        externalLocationId,
      ...
      return btapi
        ...
        .then(
          (success) => {
            ...
            let commitmentItem = btapi.getByParent(
              "id",
              commitmentOffer,
              body.cartItem
            );
  ...
  test(
    "[Step 3] Add 4 Indoor and 3 Outdoor Camera Equipment for Home Secuirty",
    () => {
      expect(
        shoppingCartId,
      ...
      let body = btapi.generateShoppingCartBody.addChildOffers(
        customerAccountECID,
        customerCategory,
        distributionChannel,
        externalLocationId,
      ...
      return btapi
        ...
        .then(
          (success) => {
            ...
            expect(
              controlPlusVideoItemId,
              "controlPlusVideo offer (" +
                controlPlusVideoOffer +
                ") should be present in response as 2 equipments were added.\n" +
                scText
            ).not.toBeNull();
            body.cartItem.forEach(function (item) {
              ...
              expect(
                ...
                "Place ID under " +
                  product.displayName +
                  " top offer should be the same like Place ID in request\n"
  ...
  test(
    ...
    () => {
      ...
      let body = btapi.generateShoppingCartBody.updateCharsTopItem(
        customerAccountECID,
        customerCategory,
        distributionChannel,
        externalLocationId,
          ...
          (success) => {
            ...
            expect(
              ...
              "Offer (" +
                ...
                JSON.stringify(controlPlusVideoItem, null, "\t")
            ).not.toBeNull();
            expect(
  ...
  test("[Step 5] Get Search Available Appointments", async () => {
    ...
    logger.info("CUSTOMER_ID:" + customerId);
    let response = await tapis.processSearchAvailableAppointment(
      apicfg,
      externalLocationId
    );
    let appointmentList = [];
      ...
      return btapi
        ...
        .then(
          (success) => {
            ...
            let workOfferItem = btapi.getByParent(
              "id",
              workOffer,
              body.cartItem
            );
  ...
  test(
    "[Step 6] Validate SC via SSP for RCA",
    () => {
      expect.hasAssertions();
      ...
      let body = bodySamples.validateOrSubmitBody(
        customerCategory,
        distributionChannel
      );
      ...
      return btapi
        ...
        .then(
          (success) => {
            ...
            console.log(
              "Cart Id : " +
                cartVersionBeforeSubmit +
                "cart Version Before Submit : " +
                cartVersionBeforeSubmit
            );
          },
          (error) => {
...
describe("Cease Control Plus Video", () => {
  test(
    "[Step 1] Cease Home Security Order",
    () => {
      let body = btapi.generateShoppingCartBody.generateEmptyCart(
        customerAccountECID,
        customerCategory,
        distributionChannel,
        externalLocationId
      ...
      return btapi
        ...
        .then(
          (success) => {
            ...
            shoppingCartId = body.id;
            logger.info("Shopke" + shoppingCartId);
          },
          (error) => {
            expect(
              true,
  ...
  test(
    "[Step 2] Disconnect Control Plus Video Home Secuirty",
    () => {
      expect(
        shoppingCartId,
        "SC id should not be null, please look at the previous test\n"
      ...
      var offerItemList = [controlPlusVideoItemId];
  ...
  test(
    "[Step 4] Validate SC via SSP for RCA",
    () => {
      expect.hasAssertions();
  ...
  test(
    "[Step 5]: Submit SC via SSP for RCA",
    () => {
      expect.hasAssertions();
      expect(
        shoppingCartId,
